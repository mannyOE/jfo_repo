    ...
    <div class="row" >
        <div class="col-md-12 bg-base-2">
            <div class="ttop" >
                ...
                <p style="color: #fff">
                    Learn more about nester solutions
                </p>
            </div>
        </div>
        ...
        <div class="col-md-12" style="padding: 2% 5%;">
            <div class="row" >
                <div class="col-md-8 col-xs-12" style="padding: 5%;" >
                    <div class="col-md-12 blogs " v-for="(each, index) in blogContent" :key="index">
                        <div class="row" >
                            <div class="col-md-6 col-xs-12 p-1" >
                                <img :src="$API+'contents/'+each.photo" class="img-b" width="100%" >
                            </div>
                            <div class="col-md-6 col-xs-12 p-5" >
                                <h6 v-html="each.title"></h6>
                                <p v-html="getSome(each.body)">
                                    
                                </p>
                                <button class="btn btn-default r-demo" @click="goSingle(index, each.title)">
                                    read more
                                </button>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-xs-12" style="padding: 5%;">
                    <div class="blogs" style="padding: 10%">
                        <h5>Stay Updated</h5>
                        <input class="form-control" type="text" placeholder="Name">
                        <input class="form-control" type="email" placeholder="Email">
                        <button class="btn btn-default get">
                            get started
                        </button>
                    </div>
                </div>
...
<script type="text/javascript">
	...
	export default {
		...
		methods: {
            ...
            goSingle(index, title){
                var t = title.replace(/\s+/g, "-");
                this.$router.push('blog/single/'+index+'/'+t);
            },
            ...mapActions('cmsBlog', {blogGet: 'getContent'}),
		...
		computed: {
             ...mapGetters('cmsBlog', {blogContent: 'content'}),
			allContent(){
