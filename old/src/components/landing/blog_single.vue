            ...
            <div class="row" >
                <div class="col-md-8 col-xs-12">
                     <div class="col-md-12 pp ">
                        <div class="container" >
                            <div class="row" >
                                <div class="col-md-8 col-xs-12 text-center" style="padding: 15px 2px;">
                                    <img :src="$API+'contents/'+single.photo" width="520px" class="img-v">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        methods: {
            fetchData(){
                ...
                this.blogGet(args).then(res=>{
                    ...
                    this.single = this.blogContent[ind];
                })
            },
            getSome(msg){
                if(msg.length>240){
